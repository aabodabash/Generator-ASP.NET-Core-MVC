...
namespace Mobioos.Generators.AspNetCore
{
    ...
    {
        public static Dictionary<string, AuthenticationProviderPrompt> AuthenticationProviderPrompts
        { get; } = new Dictionary<string, AuthenticationProviderPrompt>
        {
            {
                "googleAuth",
                new AuthenticationProviderPrompt(
                    "GoogleAuthClientId",
                    "Google client id",
                    "GoogleAuthSecret",
    ...
    public class AuthenticationProviderPrompt
    {
        ...
        public AuthenticationProviderPrompt(
            string clientName,
